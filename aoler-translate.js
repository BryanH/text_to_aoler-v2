function translateText( text ) {
    ...
    for ( var i = 0; i < arrayLength; i++ ) {
        ...
        if (
            ( textArray[ i ].indexOf( "YOUR" ) != -1 && textArray[ i ].indexOf( "YOUR" ) == 0 && wordLength == 4 ) ||
            ( textArray[ i ].indexOf( "YOU'RE" ) != -1 && textArray[ i ].indexOf( "YOU'RE" ) == 0 && wordLength == 6 )
        )
            output += "UR";
        else if ( textArray[ i ].indexOf( "YOU" ) != -1 )
            output += "U";
        else if ( ( textArray[ i ] + " " + textArray[ i + 1 ] + " " + textArray[ i + 2 ] ).indexOf( "GOT TO GO" ) != -1 ) {
            output += "G2G";
            i += 2;
        } else if ( ( textArray[ i ] + " " + textArray[ i + 1 ] + " " + textArray[ i + 2 ] ).indexOf( "GOT TA GO" ) != -1 ) {
            output += "G2G";
            i += 2;
        } else if ( ( textArray[ i ] + " " + textArray[ i + 1 ] ).indexOf( "GOTTA GO" ) != -1 ) {
            output += "G2G";
            i++;
        ...
        else if ( textArray[ i ].indexOf( "THE" ) != -1 && textArray[ i ].indexOf( "THE" ) == 0 && wordLength == 3 )
            if ( Math.floor( Math.random() * 100 ) % 2 )
                output += "TEH";
            else
                output += "DA";
        else if ( textArray[ i ].indexOf( "MY" ) != -1 && textArray[ i ].indexOf( "MY" ) == 0 && wordLength == 2 )
            output += "MAH";
        else if ( textArray[ i ].indexOf( "NEW" ) != -1 && textArray[ i ].indexOf( "NEW" ) == 0 && wordLength == 3 )
            output += "NU";
        else if ( textArray[ i ].indexOf( "WITH" ) != -1 && textArray[ i ].indexOf( "WITH" ) == 0 && wordLength == 4 )
            output += "WIT";
        else if ( textArray[ i ].indexOf( "REALLY" ) != -1 )
            output += "RILLY";
        else if ( textArray[ i ].indexOf( "PLEASE" ) != -1 || textArray[ i ].indexOf( "PLEEZ" ) != -1 )
            output += "PLZ";
        else if ( textArray[ i ].indexOf( "THANKS" ) != -1 )
            output += "THX";
        else if ( textArray[ i ].indexOf( "THIS" ) != -1 && textArray[ i ].indexOf( "THIS" ) == 0 && wordLength == 4 )
            output += "THES";
        else if ( textArray[ i ].indexOf( "IS" ) != -1 && textArray[ i ].indexOf( "IS" ) == 0 && wordLength == 2 )
            output += "SI";
        else if ( textArray[ i ].indexOf( "LOVE" ) != -1 && textArray[ i ].indexOf( "LOVE" ) == 0 && wordLength == 4 )
            output += "LUV";
        else if ( textArray[ i ].indexOf( "THERE" ) != -1 && textArray[ i ].indexOf( "THERE" ) == 0 && wordLength == 5 )
            if ( Math.floor( Math.random() * 100 ) % 2 )
                output += "THEIR";
            else
                output += "THEYRE";
        else if ( textArray[ i ].indexOf( "THEIR" ) != -1 && textArray[ i ].indexOf( "THEIR" ) == 0 && wordLength == 5 )
            if ( Math.floor( Math.random() * 100 ) % 2 )
                output += "THERE";
            else
                output += "THEYRE";
        else if ( textArray[ i ].indexOf( "THEY'RE" ) != -1 && textArray[ i ].indexOf( "THEY'RE" ) == 0 && wordLength == 7 )
            if ( Math.floor( Math.random() * 100 ) % 2 )
                output += "THERE";
            else
                output += "THEIR";
            ...
            output += "K";
        else if ( textArray[ i ].indexOf( "OKAY" ) != -1 && textArray[ i ].indexOf( "OKAY" ) == 0 && wordLength == 4 )
            output += "K";
        else if ( textArray[ i ].indexOf( "LIBRARY" ) != -1 && textArray[ i ].indexOf( "LIBRARY" ) == 0 && wordLength == 7 )
            output += "LIBERRY";
        else {
            ...
            for ( var j = 0; j < wordLength; j++ ) {
                ...
                // change "ck" to simply "k" unless there is an "s" after the "k"
                else if ( textArray[ i ].charAt( j ) == "C" )
                    if ( textArray[ i ].charAt( j + 1 ) == "K" ) {
                        if ( textArray[ i ].charAt( j + 2 ) == "S" ) {
                ...
                else if ( textArray[ i ].charAt( j + 1 ) == "S" ) {
                    if ( textArray[ i ].charAt( j + 2 ) == "S" ) {
                ...
                // replace "see you" or "see ya" with "cya"
                ...
                else if ( textArray[ i ].charAt( j + 1 ) + textArray[ i ].charAt( j + 2 ) + " " + textArray[ i ].charAt( 0 ) + textArray[ i ].charAt( 1 ) + textArray[ i ].charAt( 2 ) == "EE YOU" ) {

                    output += "CYA";
                    j += 5;

                } // end if
                else if ( textArray[ i ].charAt( j + 1 ) + textArray[ i ].charAt( j + 2 ) + " " + textArray[ i ].charAt( 0 ) + textArray[ i ].charAt( 1 ) == "EE YA" ) {
                    ...
                    else if ( textArray[ i ].charAt( j + 1 ) == "H" ) {

                        output += "O";
                        j++;

                    } // end if
                    else if ( textArray[ i ].charAt( j + 1 ) + textArray[ i ].charAt( j + 2 ) == "US" && textArray[ i ].charAt( j + 3 ) != "E" ) {
                        output += "OS";
                        j += 2;
                    } else
                        output += "O";
                ...
                // replace an "LY" ending with "LEY"
                else if (
                    textArray[ i ].charAt( j ) + textArray[ i ].charAt( j + 1 ) == "LY" &&
                    ( j + 2 == wordLength || textArray[ i ].charAt( j + 2 ) == "." || textArray[ i ].charAt( j + 2 ) == "!" || textArray[ i ].charAt( j + 2 ) == "?" || textArray[ i ].charAt( j + 2 ) == "'" || textArray[ i ].charAt( j + 2 ) == ";" || textArray[ i ].charAt( j + 2 ) == "," || textArray[ i ].charAt( j + 2 ) == ":" || textArray[ i ].charAt( j + 2 ) == "\"" || textArray[ i ].charAt( j + 2 ) == "`" || textArray[ i ].charAt( j + 2 ) == "~" )
                ) {
                    output += "LEY";
                    j += 2;
                }

                // replace "USE" with "UES"
                else if ( textArray[ i ].charAt( j ) + textArray[ i ].charAt( j + 1 ) + textArray[ i ].charAt( j + 2 ) == "USE" ) {
                    output += "UES";
                    j += 2;
                }
        ...
        if ( textArray[ i ].indexOf( "." ) != -1 || textArray[ i ].indexOf( "!" ) != -1 || textArray[ i ].indexOf( "?" ) != -1 ) {
            ...
            // otherwise...
                ...
                // ...ensure there is at least one exclamation mark in the output
